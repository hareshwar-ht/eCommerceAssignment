...
const features = [
  {
    ...
    description: 'JWT-based auth with refresh token rotation, HTTP-only cookies, and role-based access control.',
  },
  {
    icon: Zap,
    title: 'Lightning Fast API',
    description: 'Optimized PostgreSQL queries with connection pooling and async notification processing via RabbitMQ.',
  },
  {
    icon: Cloud,
    title: 'Cloud Ready',
    description: 'Built for scale with message queues, rate limiting, and production-grade error handling.',
  },
];
        ...
        <section className="container mx-auto px-4 py-20 sm:px-6 sm:py-28 lg:px-8 lg:py-36">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mx-auto mt-6 max-w-xl text-base text-muted-foreground sm:text-lg">
              A production-ready starter with secure authentication, real-time notifications,
              and a modern tech stack. Ship faster, scale easier.
            </p>
        ...
        <section id="features" className="container mx-auto px-4 py-16 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-3 text-muted-foreground">
              Built with best practices for security, performance, and developer experience.
            </p>
          </div>
